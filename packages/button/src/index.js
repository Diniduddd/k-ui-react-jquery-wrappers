...
const KendoButton = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiButton.ui.Button(elementNode,this.props.options);
	...
	render: function() {
		return this.props.children ? <span>{this.props.children}</span> : <button />;
	}
});
